...
export default function InventoryDashboard() {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      // Call warehouse manager dashboard API if warehouse manager
      if (isWarehouseManager) {
        const dashboardRes = await fetch('/api/warehouse-manager/inventory/dashboard', {
        ...
        if (dashboardRes.ok) {
          ...
          setStats({
            ...
            activeSKUs: data.total_products || 0,
            totalStockValue: data.total_value || 0,
            totalCustomers: 0,
          });
        }
        setLoading(false);
